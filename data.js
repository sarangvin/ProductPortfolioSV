...
const DATA = {
  ...
  hobbyProjects: [
    ...
    { status: "Ongoing", kind: "Knowledge", title: "Rabbithole",
      desc: "A personal knowledge base for going properly down a rabbithole on a topic, a day at a time — started as an Obsidian vault with scripting, now growing into its own React/TypeScript web app with an admin panel.",
      metrics: ["Obsidian vault + scripts", "React/TS rebuild in progress"],
      tags: ["Obsidian", "React", "TypeScript"],
      link: { href: "demo/rabbithole/", label: "Open the demo" }, featured: true },
